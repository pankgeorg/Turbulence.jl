...
| 4 | k–ω SST implemented + channel395 + backstep       | Layer 2 + Layer 3 pass                                 | ◑ closure ✅; **channel passes at 1.7% mean** via native Menter ω-wall treatment (no Spalding WF). Backstep (Layer 3) pending. `ShipFlow.jl/RESULTS-channel-sst.md` |
